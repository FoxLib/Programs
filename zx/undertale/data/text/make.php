...
$text[] = "Давным давно две расы правили Землей: люди и монстры.";
$text[] = "Но однажды между ними вспыхнула война.";
$text[] = "После продолжительной битвы людям удалось одержать победу";
$text[] = "И с помощью волшебного заклятья они заключили монстров под землю.";
$text[] = "Много лет спустя...";
$text[] = "Гора Эббот. 201Х";
$text[] = "Легенды гласят, что те, кто взобрался на гору, больше не возвращаются.";
