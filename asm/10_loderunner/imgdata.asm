...
; Конверсия внутреннего представления в номера тайлов
tile_convert:

        ; SpriteID  Номер палитры
        db  24, 2                   ; 0 Пустота
        db  25, 1                   ; 1 Кирпичи
        db  27, 3                   ; 2 Лестница
        db  31, 4                   ; 3 Золото
...
sprites:
        ...
        ;[3:0] Палитра [7] Невидимый=1 [4] Направление
        ;      X              Y     ID Палитра
        ;     +0     +1      +2     +3      +4
        db  0xA0, 0x00,   0xB0,   0x12,   0x00  ; 0  Игрок
        db  0x10, 0x00,   0x00,   0x00,   0x80  ; 5  Враг 1
        db  0x20, 0x00,   0x00,   0x00,   0x80  ; 10 Враг 2
        db  0x30, 0x00,   0x00,   0x00,   0x80  ; 15 Враг 3
        db  0x40, 0x00,   0x00,   0x00,   0x80  ; 20 Фрукт
